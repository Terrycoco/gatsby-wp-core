...
exports.fetchAndCreateSingleNode = exports.default = exports.createSingleNode = void 0;
...
const createSingleNode = async ({
  ...
  let remoteNode = (0, _fetchReferencedMediaItems.addImageCDNFieldsToNode)({ ...processedNode,
