...
exports.typeIsASupportedScalar = exports.typeIsABuiltInScalar = exports.getTypeSettingsByType = exports.findTypeName = exports.findTypeKind = exports.filterTypeDefinition = exports.fieldOfTypeWasFetched = exports.buildTypeName = void 0;
...
const getTypeSettingsByType = type => {
  ...
  const typeSettings = (0, _cloneDeep2.default)(allTypeSettings[typeName] || {}); // the type.__all plugin option which is applied to every type setting
